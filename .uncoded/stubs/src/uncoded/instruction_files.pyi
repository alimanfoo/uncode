...
_SECTION_BODY = ...  # L17-65
SECTION = f'{MARKER_START}\n{_SECTION_BODY}\n{MARKER_END}\n'  # L67

def generate_section() -> str:  # L70-72
    """Return the full delimited uncoded section for an instruction file."""
    ...

def _replace_or_append(existing: str, section: str) -> str:  # L75-85
    """Replace the delimited section in existing text, or append it if absent."""
    ...

def sync_instruction_file(path: Path) -> None:  # L88-99
